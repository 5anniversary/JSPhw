 ...
 * Generated at: 2020-04-11 15:11:03 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.form02;
...
if (request.getMethod().equals("POST")) {
	...
	if (userid == null || userid.length() == 0)
      ...
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>사용자 아이디</label> <input type=\"text\" class=\"text\" name=\"userid\"\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(userid);
      out.write("\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>이름</label> <input type=\"text\" class=\"text\" name=\"name\"\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(name);
      out.write("\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>비밀번호1</label> <input type=\"password\" class=\"text\"\n");
      out.write("\t\t\t\t\tname=\"password1\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>비밀번호2</label> <input type=\"password\" class=\"text\"\n");
      out.write("\t\t\t\t\tname=\"password2\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>이메일</label> <input type=\"email\" class=\"text\" name=\"email\"\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(email);
      out.write("\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>학과</label> <select class=\"form-control\" name=\"department\">\n");
